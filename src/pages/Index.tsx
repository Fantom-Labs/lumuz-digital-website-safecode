      ...
      <section id="contato" className="py-32 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="bg-[#1A1A1A] rounded-lg p-12 flex flex-col items-center justify-center text-center space-y-8">
              <img
                src="/lovable-uploads/141c127b-1d2e-40a5-a18f-5ff83f8b4cf1.png"
                alt="Lumuz Digital"
                className="w-48"
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#1A1A1A] hover:bg-white/10 transition-all duration-300 rounded-full px-6 py-3 w-full border border-white/10"
              >
